...
viewer(grafica_1, bayesianNetwork.title = "Red 1", node.shape = c("circle"), 
       node.colors = list(background = "#f4bafd", border = "#2b7ce9",
...
viewer(grafica_2, bayesianNetwork.layout = "layout_with_sugiyama", edges.smooth = FALSE, 
       node.shape = c("circle"), bayesianNetwork.title = "Gráfica 2")
```
...
viewer(grafica_3, bayesianNetwork.layout = "layout_with_sugiyama", edges.smooth = FALSE, 
       node.shape = c("circle"), bayesianNetwork.title = "Gráfica 3")
```
...
viewer(grafica_4, bayesianNetwork.layout = "layout_with_sugiyama", edges.smooth = FALSE, 
       node.shape = c("circle"), bayesianNetwork.title = "Gráfica 4")
...
viewer(grafica_5, bayesianNetwork.layout = "layout_with_sugiyama", edges.smooth = FALSE, 
       node.shape = c("circle"), bayesianNetwork.title = "Gráfica 5")
...
viewer(graf_hc, bayesianNetwork.layout = "layout_with_sugiyama", edges.smooth = FALSE, 
       node.shape = c("circle"), bayesianNetwork.title = "graf HC")
```
...
viewer(grafica_0, bayesianNetwork.layout = "layout_with_sugiyama", edges.smooth = FALSE, 
       node.shape = c("circle"), bayesianNetwork.title = "gráfica 0")
...
viewer(graf_x, bayesianNetwork.layout = "layout_with_sugiyama", edges.smooth = FALSE, 
       node.shape = c("circle"), bayesianNetwork.title = "graf X")
...
viewer(grafica.1, bayesianNetwork.layout = "layout_with_sugiyama", edges.smooth = FALSE, 
       node.shape = c("circle"), bayesianNetwork.title = "gráfica 1")
...
```{r}
grafica.1 <- hc(dat, score='aic')
viewer(grafica.1, bayesianNetwork.layout = "layout_as_tree", edges.smooth = TRUE, 
       node.shape = c("circle"), bayesianNetwork.title = "gráfica 1")
...
viewer(grafica.bic, bayesianNetwork.layout = "layout_with_sugiyama", edges.smooth = FALSE, 
       node.shape = c("circle"), bayesianNetwork.title = "gráfica BIC")
...
viewer(grafica.aic, bayesianNetwork.layout = "layout_with_gem", edges.smooth = FALSE, 
       node.shape = c("circle"), bayesianNetwork.title = "gráfica AIC")
```
...
```{r}
viewer(hc(dat.x, score='bic', whitelist=data.frame(from=c('d'), to=c('b'))), bayesianNetwork.layout = "layout_with_gem", edges.smooth = FALSE, 
       node.shape = c("circle"), bayesianNetwork.title = "gráfica HC BIC")
...
viewer(grafica.2, bayesianNetwork.layout = "layout_with_sugiyama", edges.smooth = FALSE, 
       node.shape = c("circle"), bayesianNetwork.title = "gráfica 2")
viewer(grafica.bic, bayesianNetwork.layout = "layout_with_sugiyama", edges.smooth = FALSE, 
       node.shape = c("circle"), bayesianNetwork.title = "gráfica BIC")
...
P(E|Culpable)
$$
Así como la probabilidad de que se produzca la evidencia _E_ cuando el sospechoso no es culpable.
...
Ahora podemos calcular el _momio_ de que el acusado sea culpable cuando hemos observado la evidencia E, respecto de la probabilidad de que sea inocente.
...
```{r, echo=FALSE}
  a <- bayes_dulces(10, 8, priors, dulces_limon_bi)
...
Claramente la bolsa $b_1$ no puede producir dulces de limón y la $b_5$ sólo puede producir dulces de limón, así que las probabilidades de cualquier cosa distinto de esas condiciones está asociada a un valor de cero.
